...
import com.example.API_Vendedor.Service.UsuarioService;
...
public class UsuarioControlers {
    ...
    @PostMapping
    public ResponseEntity<UsuarioModelo> crear(@RequestBody CrearUsuario request) {
        UsuarioModelo creado = service.crearUsuario(request);
