...
import static com.example.API_Gateway.jwt.security.PublicRoutes.*; //importa las rutas publicas de jwt
import static com.example.API_Gateway.redireccion.GestionPublicRoutes.*; //importa las rutas publicas de API Personas
